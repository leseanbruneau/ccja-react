    ...
    <div className="container">
      ...
      <div className="row ml-3">
        <div className="col-xs-12 col-md-6 col-xl-3">
          ...
          <a href="http://leseanbruneau.github.io" target="_blank" rel="noopener noreferrer">Website</a>
        </div>
        <div className="col-xs-12 col-md-6 col-xl-3">
        ...
        <div className="col-xs-12 col-md-6 col-xl-3">
          ...
          <a href="https://github.com/leseanbruneau/ccja-react" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
        </div>
      </div>
      <hr />
